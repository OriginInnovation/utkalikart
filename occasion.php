...
if (isset($_GET['id'])) {
    $_SESSION['occasion_id'] = $_GET['id'];
    $encoded_id = $_GET['id'];
    $occasionId = base64_decode($_SESSION['occasion_id']);
} else {
    if (isset($_SESSION['occasion_id'])) {
        $encoded_id = $_SESSION['occasion_id'];
        $occasionId = base64_decode($_SESSION['occasion_id']);
    } else {
        $occasionId = null;
    }
...
<head>
    ...
    <title> sub sub categories</title>
