...
<head>
    ...
    <title>Shipping FAQs - E-Commerce</title>
...
<body>
    ...
    <section class="shippingfaq">
        <div class="shipping-faq">
            <h2><i class="fa-solid fa-truck"></i> Shipping FAQs</h2>
            ...
            <div class="faq-item">
                ...
                <div id="faq1" class="collapse">
                    <div class="faq-answer">
                        We offer standard, express, and next-day shipping options. Availability depends on your location and products.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div id="faq2" class="collapse">
                    <div class="faq-answer">
                        Shipping costs depend on your delivery address, selected method, and order total. Final costs are shown during checkout.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div id="faq3" class="collapse">
                    <div class="faq-answer">
                        Standard shipping takes 3–7 business days. Express and next-day shipping are faster but cost more.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div id="faq4" class="collapse">
                    <div class="faq-answer">
                        Yes, we ship internationally. Shipping fees and delivery times vary depending on your location.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div id="faq5" class="collapse">
                    <div class="faq-answer">
                        If your order hasn't shipped, you can update the address by contacting customer service immediately.
                    </div>
                </div>
            </div>
