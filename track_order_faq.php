...
<head>
    ...
    <title>Track Order FAQs - E-Commerce</title>
    ...
    <style>
        ...
        .track-faq-question:hover,
        .track-faq-question[aria-expanded="true"] {
        ...
        .track-faq-question[aria-expanded="true"] .icon-arrow {
...
<body>
    ...
    <section class="trackfaq">
        <div class="faq-container">
            <h2 class="faq-title"><i class="fa-solid fa-truck-fast"></i> Track Order FAQs</h2>

            <!-- FAQ 1 -->
            <div class="track-faq-item">
                <h2>
                    <button class="track-faq-question" type="button" data-bs-toggle="collapse" data-bs-target="#trackFaq1" aria-expanded="false" aria-controls="trackFaq1">
                        <span>How can I track my order?</span>
                        <i class="fa-solid fa-chevron-down icon-arrow"></i>
                    </button>
                </h2>
                <div id="trackFaq1" class="collapse">
                    <div class="track-faq-answer">
                        You can track your order by entering your order number and registered email on the Track Order page.
                    </div>
                </div>
            </div>
            ...
            <div class="track-faq-item">
                <h2>
                    <button class="track-faq-question" type="button" data-bs-toggle="collapse" data-bs-target="#trackFaq2" aria-expanded="false" aria-controls="trackFaq2">
                        <span>What information do I need to track my order?</span>
                        <i class="fa-solid fa-chevron-down icon-arrow"></i>
                    </button>
                </h2>
                <div id="trackFaq2" class="collapse">
                    <div class="track-faq-answer">
                        You will need your order number and the email address you used when placing the order.
                    </div>
                </div>
            </div>
            ...
            <div class="track-faq-item">
                <h2>
                    <button class="track-faq-question" type="button" data-bs-toggle="collapse" data-bs-target="#trackFaq3" aria-expanded="false" aria-controls="trackFaq3">
                        <span>What if I can’t find my order number?</span>
                        <i class="fa-solid fa-chevron-down icon-arrow"></i>
                    </button>
                </h2>
                <div id="trackFaq3" class="collapse">
                    <div class="track-faq-answer">
                        Please check your order confirmation email or contact our support team for assistance.
                    </div>
                </div>
            </div>
            ...
            <div class="track-faq-item">
                <h2>
                    <button class="track-faq-question" type="button" data-bs-toggle="collapse" data-bs-target="#trackFaq4" aria-expanded="false" aria-controls="trackFaq4">
                        <span>How long does it take for tracking information to update?</span>
                        <i class="fa-solid fa-chevron-down icon-arrow"></i>
                    </button>
                </h2>
                <div id="trackFaq4" class="collapse">
                    <div class="track-faq-answer">
                        Tracking info is usually updated within 24 hours of shipment. If you don’t see updates, please contact support.
                    </div>
                </div>
            </div>
        </div>
