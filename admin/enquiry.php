...
<head>
    ...
    <title>Indus-Supply | Product Enquiry</title>
                ...
                <div class="col-12">
                    <div class="card mt-3">
                        <div class="card-header">
                            <h3 class="home_color">Product Enquiry</h3>
                        </div>
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    include 'conn.php';
                                    $sql = "SELECT * FROM enquiry WHERE service_name = ''";
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a onclick="confirmDelete(<?php echo $row['id']; ?>, tb='enquiry', tbc='id', returnpage='enquiry.php');"
                                                    title="Delete">
