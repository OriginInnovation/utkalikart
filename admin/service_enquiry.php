...
<head>
    ...
    <title>Indus-Supply | Service Enquiry</title>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column">
                <li class="nav-item menu-open">
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="service_enquiry" class="nav-link active">
                                <i class="fa fa-question-circle nav-icon"></i>
                                <p>Service Enquiry</p>
                                <i class="right fas fa-angle-right"></i>
                            </a>
                ...
                <div class="col-12">
                    <div class="card mt-3">
                        <div class="card-header">
                            <h3 class="home_color">Service Enquiry</h3>
                        </div>
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    include 'conn.php';
                                    $sql = "SELECT * FROM enquiry WHERE product_code IS NULL";
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php
                                                $date = new DateTime($row['date_of_enquiry']);
                                                echo $date->format('M d, Y h:i A');
                                                ?>
                                            </td>
                                            <td class="text-center">
                                                <a onclick="confirmDelete(<?php echo $row['id']; ?>, tb='enquiry', tbc='id', returnpage='service_enquiry');"
                                                    title="Delete">
